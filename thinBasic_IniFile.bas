...
#RESOURCE VERSION$ "FileDescription",  "Module for INI file handling in thinBASIC"
#RESOURCE VERSION$ "FileVersion",      "1.9.16.1"
#RESOURCE VERSION$ "InternalName",     "IniFile"
#RESOURCE VERSION$ "OriginalFilename", "ThinBASIC_IniFile.dll"
...
#INCLUDE "IniFile_thinBASICInterface.inc
